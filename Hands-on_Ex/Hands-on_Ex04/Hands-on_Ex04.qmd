...
## Specify quantiles by cut points such as 2.5% and 97.5% tails to colour the ridgeline plot
...
## Display my_sum tibble data frame in an html table format
